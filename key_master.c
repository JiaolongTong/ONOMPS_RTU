...
int main(int argc, char *argv[])
{
        ...
        int16_t error_regs[100]={0};
        int16_t power_regs[100]={0};
  	int tty_fd,key_fd;
	int  i = 0, count,regs;
        int mode;
                     ...
                     switch(ev_key.code){
		                ...
		                case 22:
		                    if (0 == ev_key.value) {
                                        ...
                                        regs=modbus_read_registers(mb, 0x000B,1, error_regs);
		                        regs=modbus_read_registers(mb, error_regs[0],s1,power_regs);
		                        printf("异常光路:[%d]=%d\n",error_regs[0],power_regs[0]);

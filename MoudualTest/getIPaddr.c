...
static int get_addr(unsigned char *addr, int flag)
{
    ...
    if (SIOCGIFHWADDR == flag){
        ...
        snprintf((char *)addr, strlen(addr), "%s", inet_ntoa(sin->sin_addr));
    }
